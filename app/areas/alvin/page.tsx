...
export default function AlvinPage() {
  const pageSchema = {
    ...
    "mainEntity": {
      "@type": "ItemList",
      "name": "HVAC Services & Installation Pricing in Alvin, TX",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "item": {
            "@type": "Service",
            "name": "RunTru by Trane AC & Heating System Installation in Alvin, TX — Value Tier",
            "description": "Complete new RunTru by Trane AC and heating system installation for Alvin homeowners. Fully installed by our licensed Texas HVAC technicians (TACLB12058E). Family-owned and operated at 2110 S Gordon St in Alvin since 1986.",
            "provider": { "@id": "https://mabryac.com/#business" },
            "areaServed": { "@type": "City", "name": "Alvin", "addressRegion": "TX" },
            "offers": {
              "@type": "Offer",
  ...
  return (
    <>
      ...
      <section className="bg-primary py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold text-white mb-4">
            AC Repair &amp; HVAC Serving Alvin, TX &amp; the Greater Houston Area — Your Local Experts Since 1986
          </h1>
      ...
      {/* Visible pricing band — attention-grabbing, above reviews */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="flex items-start gap-4 bg-accent/5 border border-accent/20 rounded-2xl p-6">
              ...
              <div>
                <div className="text-2xl font-black text-primary leading-tight">$79 Flat-Rate Service Call</div>
            ...
            >
              ...
              <div>
                <div className="text-2xl font-black text-primary leading-tight">New AC &amp; Heating Systems from $12,140</div>
                <p className="text-muted-foreground text-sm mt-1">
