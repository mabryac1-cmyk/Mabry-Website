...
export const metadata: Metadata = {
  ...
  description: `Contact ${businessInfo.name} for residential AC and heating service. Serving Alvin, Friendswood, Pearland, Clear Lake & many more cities across the greater Houston area. License ${businessInfo.license}. BBB A+ Rated.`,
  alternates: {
    canonical: "/contact",
  },
};
