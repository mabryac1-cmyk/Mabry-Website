module.exports=[70943,(e,i,n)=>{"use strict";Object.defineProperty(n,"__esModule",{value:!0});var r={getOrigin:function(){return s},resolveArray:function(){return t},resolveAsArrayOrUndefined:function(){return o}};for(var a in r)Object.defineProperty(n,a,{enumerable:!0,get:r[a]});function t(e){return Array.isArray(e)?e:[e]}function o(e){if(null!=e)return t(e)}function s(e){let i;if("string"==typeof e)try{i=(e=new URL(e)).origin}catch{}return i}},73853,(e,i,n)=>{"use strict";Object.defineProperty(n,"__esModule",{value:!0});var r={resolveManifest:function(){return l},resolveRobots:function(){return o},resolveRouteData:function(){return d},resolveSitemap:function(){return s}};for(var a in r)Object.defineProperty(n,a,{enumerable:!0,get:r[a]});let t=e.r(70943);function o(e){let i="";for(let n of Array.isArray(e.rules)?e.rules:[e.rules]){for(let e of(0,t.resolveArray)(n.userAgent||["*"]))i+=`User-Agent: ${e}
`;if(n.allow)for(let e of(0,t.resolveArray)(n.allow))i+=`Allow: ${e}
`;if(n.disallow)for(let e of(0,t.resolveArray)(n.disallow))i+=`Disallow: ${e}
`;n.crawlDelay&&(i+=`Crawl-delay: ${n.crawlDelay}
`),i+="\n"}return e.host&&(i+=`Host: ${e.host}
`),e.sitemap&&(0,t.resolveArray)(e.sitemap).forEach(e=>{i+=`Sitemap: ${e}
`}),i}function s(e){let i=e.some(e=>Object.keys(e.alternates??{}).length>0),n=e.some(e=>{var i;return!!(null==(i=e.images)?void 0:i.length)}),r=e.some(e=>{var i;return!!(null==(i=e.videos)?void 0:i.length)}),a="";for(let l of(a+='<?xml version="1.0" encoding="UTF-8"?>\n',a+='<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"',n&&(a+=' xmlns:image="http://www.google.com/schemas/sitemap-image/1.1"'),r&&(a+=' xmlns:video="http://www.google.com/schemas/sitemap-video/1.1"'),i?a+=' xmlns:xhtml="http://www.w3.org/1999/xhtml">\n':a+=">\n",e)){var t,o,s;a+="<url>\n",a+=`<loc>${l.url}</loc>
`;let e=null==(t=l.alternates)?void 0:t.languages;if(e&&Object.keys(e).length)for(let i in e)a+=`<xhtml:link rel="alternate" hreflang="${i}" href="${e[i]}" />
...
`),a+="</url>\n"}return a+"</urlset>\n"}function l(e){return JSON.stringify(e)}function d(e,i){return"robots"===i?o(e):"sitemap"===i?s(e):"manifest"===i?l(e):""}},8922,e=>{"use strict";var i=e.i(47909),n=e.i(74017),r=e.i(96250),a=e.i(59756),t=e.i(61916),o=e.i(74677),s=e.i(69741),l=e.i(16795),d=e.i(87718),c=e.i(95169),u=e.i(47587),h=e.i(66012),p=e.i(70101),g=e.i(26937),m=e.i(10372),y=e.i(93695);e.i(52474);var f=e.i(220),v=e.i(89171);let w=[{slug:"ac-repair",name:"AC Repair",title:"AC Repair Services",shortDescription:"Fast, reliable residential AC repair",description:"Fast, reliable residential AC repair services. We fix all makes and models with honest, flat-rate pricing.",content:`
    ...
    `,keywords:["HVAC Rosharon TX","AC repair Rosharon","heating repair Rosharon TX","air conditioning Rosharon"]}],C="https://www.mabryac.com";function b(){return[{url:C,lastModified:new Date,changeFrequency:"weekly",priority:1},{url:`${C}/about`,lastModified:new Date,changeFrequency:"monthly",priority:.8},{url:`${C}/contact`,lastModified:new Date,changeFrequency:"monthly",priority:.9},{url:`${C}/reviews`,lastModified:new Date,changeFrequency:"monthly",priority:.7},...w.map(e=>({url:`${C}/services/${e.slug}`,lastModified:new Date,changeFrequency:"monthly",priority:.9})),...A.map(e=>({url:`${C}/areas/${e.slug}`,lastModified:new Date,changeFrequency:"monthly",priority:.8})),...w.flatMap(e=>A.map(i=>({url:`${C}/services/${e.slug}/${i.slug}`,lastModified:new Date,changeFrequency:"monthly",priority:.7})))]}e.s(["default",()=>b],89282);var H=e.i(73853);async function R(){let e=await b(),i=(0,H.resolveRouteData)(e,"sitemap");return new v.NextResponse(i,{headers:{"Content-Type":"application/xml","Cache-Control":"public, max-age=0, must-revalidate"}})}e.s(["GET",()=>R],39248),e.i(39248),e.i(89282),e.s(["GET",()=>R],21330);var S=e.i(21330);let T=new i.AppRouteRouteModule({definition:{kind:n.RouteKind.APP_ROUTE,page:"/sitemap.xml/route",pathname:"/sitemap.xml",filename:"sitemap--route-entry",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/sitemap--route-entry.js",nextConfigOutput:"standalone",userland:S}),{workAsyncStorage:k,workUnitAsyncStorage:P,serverHooks:B}=T;function x(){return(0,r.patchFetch)({workAsyncStorage:k,workUnitAsyncStorage:P})}async function M(e,i,r){T.isDev&&(0,a.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let v="/sitemap.xml/route";v=v.replace(/\/index$/,"")||"/";let w=await T.prepare(e,i,{srcPage:v,multiZoneDraftMode:!1});if(!w)return i.statusCode=400,i.end("Bad Request"),null==r.waitUntil||r.waitUntil.call(r,Promise.resolve()),null;let{buildId:A,params:C,nextConfig:b,parsedUrl:H,isDraftMode:R,prerenderManifest:S,routerServerContext:k,isOnDemandRevalidate:P,revalidateOnlyGenerated:B,resolvedPathname:x,clientReferenceManifest:M,serverActionsManifest:E}=w,L=(0,s.normalizeAppPath)(v),V=!!(S.dynamicRoutes[L]||S.routes[x]),q=async()=>((null==k?void 0:k.render404)?await k.render404(e,i,H,!1):i.end("This page could not be found"),null);if(V&&!R){let e=!!S.routes[x],i=S.dynamicRoutes[L];if(i&&!1===i.fallback&&!e){if(b.experimental.adapterPath)return await q();throw new y.NoFallbackError}}let F=null;!V||T.isDev||R||(F="/index"===(F=x)?"/":F);let _=!0===T.isDev||!V,$=V&&!_;E&&M&&(0,o.setManifestsSingleton)({page:v,clientReferenceManifest:M,serverActionsManifest:E});let D=e.method||"GET",N=(0,t.getTracer)(),W=N.getActiveScopeSpan(),X={params:C,prerenderManifest:S,renderOpts:{experimental:{authInterrupts:!!b.experimental.authInterrupts},cacheComponents:!!b.cacheComponents,supportsDynamicResponse:_,incrementalCache:(0,a.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:b.cacheLife,waitUntil:r.waitUntil,onClose:e=>{i.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(i,n,r,a)=>T.onRequestError(e,i,r,a,k)},sharedContext:{buildId:A}},O=new l.NodeNextRequest(e),z=new l.NodeNextResponse(i),I=d.NextRequestAdapter.fromNodeNextRequest(O,(0,d.signalFromNodeResponse)(i));try{let o=async e=>T.handle(I,X).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":i.statusCode,"next.rsc":!1});let n=N.getRootSpanAttributes();if(!n)return;if(n.get("next.span_type")!==c.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${n.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let r=n.get("next.route");if(r){let i=`${D} ${r}`;e.setAttributes({"next.route":r,"http.route":r,"next.span_name":i}),e.updateName(i)}else e.updateName(`${D} ${v}`)}),s=!!(0,a.getRequestMeta)(e,"minimalMode"),l=async a=>{var t,l;let d=async({previousCacheEntry:n})=>{try{if(!s&&P&&B&&!n)return i.statusCode=404,i.setHeader("x-nextjs-cache","REVALIDATED"),i.end("This page could not be found"),null;let t=await o(a);e.fetchMetrics=X.renderOpts.fetchMetrics;let l=X.renderOpts.pendingWaitUntil;l&&r.waitUntil&&(r.waitUntil(l),l=void 0);let d=X.renderOpts.collectedTags;if(!V)return await (0,h.sendResponse)(O,z,t,X.renderOpts.pendingWaitUntil),null;{let e=await t.blob(),i=(0,p.toNodeOutgoingHttpHeaders)(t.headers);d&&(i[m.NEXT_CACHE_TAGS_HEADER]=d),!i["content-type"]&&e.type&&(i["content-type"]=e.type);let n=void 0!==X.renderOpts.collectedRevalidate&&!(X.renderOpts.collectedRevalidate>=m.INFINITE_CACHE)&&X.renderOpts.collectedRevalidate,r=void 0===X.renderOpts.collectedExpire||X.renderOpts.collectedExpire>=m.INFINITE_CACHE?void 0:X.renderOpts.collectedExpire;return{value:{kind:f.CachedRouteKind.APP_ROUTE,status:t.status,body:Buffer.from(await e.arrayBuffer()),headers:i},cacheControl:{revalidate:n,expire:r}}}}catch(i){throw(null==n?void 0:n.isStale)&&await T.onRequestError(e,i,{routerKind:"App Router",routePath:v,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:$,isOnDemandRevalidate:P})},!1,k),i}},c=await T.handleResponse({req:e,nextConfig:b,cacheKey:F,routeKind:n.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:S,isRoutePPREnabled:!1,isOnDemandRevalidate:P,revalidateOnlyGenerated:B,responseGenerator:d,waitUntil:r.waitUntil,isMinimalMode:s});if(!V)return null;if((null==c||null==(t=c.value)?void 0:t.kind)!==f.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==c||null==(l=c.value)?void 0:l.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});s||i.setHeader("x-nextjs-cache",P?"REVALIDATED":c.isMiss?"MISS":c.isStale?"STALE":"HIT"),R&&i.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let y=(0,p.fromNodeOutgoingHttpHeaders)(c.value.headers);return s&&V||y.delete(m.NEXT_CACHE_TAGS_HEADER),!c.cacheControl||i.getHeader("Cache-Control")||y.get("Cache-Control")||y.set("Cache-Control",(0,g.getCacheControlHeader)(c.cacheControl)),await (0,h.sendResponse)(O,z,new Response(c.value.body,{headers:y,status:c.value.status||200})),null};W?await l(W):await N.withPropagatedContext(e.headers,()=>N.trace(c.BaseServerSpan.handleRequest,{spanName:`${D} ${v}`,kind:t.SpanKind.SERVER,attributes:{"http.method":D,"http.target":e.url}},l))}catch(i){if(i instanceof y.NoFallbackError||await T.onRequestError(e,i,{routerKind:"App Router",routePath:L,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:$,isOnDemandRevalidate:P})},!1,k),V)throw i;return await (0,h.sendResponse)(O,z,new Response(null,{status:500})),null}}e.s(["handler",()=>M,"patchFetch",()=>x,"routeModule",()=>T,"serverHooks",()=>B,"workAsyncStorage",()=>k,"workUnitAsyncStorage",()=>P],8922)}];
